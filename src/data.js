export const projects = [
  {
    ...
    descriptionDe:
      "Meine erste vollständig Frontend-Website. Dieses erste Eintauchen in die Programmierung ermöglichte es mir, KI-generierte Bilder und einige interaktive Funktionen zu integrieren.",
  ...
  },
  {
    ...
    descriptionDe:
      '"Oh no Lola" wurde mit dem Schwerpunkt auf Bildung entwickelt, insbesondere auf Leseverständnis. Jede Geschichte stammt von mir und soll subtile Lebenslektionen durch einfache Erzählungen vermitteln.',
  ...
  },
  {
    ...
    descriptionDe:
      "Ein dynamisches und benutzerfreundliches Python-Projekt zur Vereinfachung der Verwaltung von Dienstleistungen, Preisen und Verkäufen für Salon LaVida. Inspiriert vom Salon meiner Schwester ermöglicht es die Nachverfolgung von Produkten und Dienstleistungen, die Berechnung von Gesamtsummen und die effiziente Abwicklung von Verkäufen. Das System unterstützt genaue Aufzeichnungen und erleichtert den täglichen Betrieb.",
  ...
  },
  {
    ...
    descriptionDe:
      "Ein persönlicher Blog, in dem ich meine Reise des spirituellen Wachstums und der Inklusion teile. In diesem Projekt befasse ich mich mit Themen wie Glaube, Identität und bedingungsloser Liebe, um LGBTQ+-Personen Hoffnung und Unterstützung zu geben, die ähnliche Erfahrungen machen.",
  ...
  },
  {
    ...
    descriptionDe:
      "Eine Plattform, die es Kunden ermöglicht, eigene Designs hochzuladen und zu drucken oder vorgefertigte Produkte zu kaufen. Sie bietet Flexibilität und Kreativität, darunter Visitenkarten, Poster, T-Shirts, Schreibwaren und digitale Vorlagen. Das Projekt wurde von Plattformen wie Wirmachendruck in Deutschland und Upwork in den USA inspiriert und legt den Schwerpunkt auf praktische digitale Designlösungen.",
  ...
  },
  {
    ...
    descriptionDe:
      "Eine Campervan-Vermietungs-Website mit Buchungssystem, Kalenderfunktion und Stripe-Integration. Enthält hochwertige Bilder, einen FAQ-Bereich, YouTube-Videos und empfohlene Campingplätze.",
...
export const designs = [
  {
    ...
    descriptionDE: "Kreatives 50-seitiges Buch, gestaltet in Adobe InDesign.",
  ...
  },
  {
    ...
    descriptionDE: "Handgezeichnetes Logo für eine Fastengruppe.",
  ...
  },
  {
    ...
    descriptionDE: "Vektorisierte Bildgestaltung für Metall-CNC-Schneiden.",
  ...
  },
  {
    ...
    descriptionDE:
      "Mockup-Design für einen umweltfreundlichen Gästehaus-Flyer.",
